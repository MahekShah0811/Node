...
// data => convert => token (jwt) => save cookie
app.get("/jwt", (req, res) => {
    let data = {
        username: "test", 
...
// use case: when your data leak your password is safe, if you encrypt your all user user password
